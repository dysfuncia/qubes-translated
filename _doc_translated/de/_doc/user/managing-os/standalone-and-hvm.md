...
A [StandaloneVM](/de/doc/glossary/#standalonevm) is a type of VM in Qubes that is created by cloning a [TemplateVM
...
![r2b1-manager-networking-config.png](/de/attachment/wiki/HvmCreate/r2b1-manager-networking-config.png)
...
Qubes allows HVMs to share a common root filesystem from a select TemplateVM (see [TemplateHVM](/de/doc/glossary/#templatehvm) and [TemplateBasedHVM
...
![r2b1-win7-usb-disable.png](/de/attachment/wiki/HvmCreate/r2b1-win7-usb-disable.png)
