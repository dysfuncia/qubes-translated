...
redirect_from:
- /de/de/de/doc/QubesBuilder/
- /de/de/de/wiki/QubesBuilder/
ref: 206
title: Qubes Builder
translated: 'yes'
---
...
for use with [QubesBuilder](/de/doc/qubes-builder/) take a look at [doc directory
in QubesBuilder](https://github.com/marmarek/qubes-builder/tree/master/doc) or 
[QubesBuilderDetails](/de/doc/qubes-builder-details/) page.
